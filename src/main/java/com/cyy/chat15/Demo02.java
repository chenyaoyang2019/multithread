...
public class Demo02 {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        //异步下单购买冰箱
        Future<GoogsModel> bxFuture = executorService.submit(buyGoods("冰箱", 5));
        //异步下单购买洗衣机
        Future<GoogsModel> xyjFuture = executorService.submit(buyGoods("洗衣机", 2));
        //关闭线程池
        executorService.shutdown();

        //等待洗衣机送到
        GoogsModel xijGoogsModel = xyjFuture.get();
        //将洗衣机搬上楼
        moveUP(xijGoogsModel);

        //等待冰箱送到
        GoogsModel bxGoogsModel = bxFuture.get();
        //将冰箱搬上楼
        moveUP(bxGoogsModel);
